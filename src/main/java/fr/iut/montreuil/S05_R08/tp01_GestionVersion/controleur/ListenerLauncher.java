        ...
        ChangeListener c = new ChangeListener() {
            ...
            public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                switch (joueur.getNumeroZone()){
                    case "0":
                        if(joueur.isCollinding(9*16, 16) && !joueur.getListeQuetes().getQueteActuelle().getTitre().startsWith("Chapitre 0") && (joueur.getCompteurPas() >= 5000 || joueur.getListeQuetes().getQueteActuelle().getDescription().startsWith("Parlez au vendeur")))  {
